    ...
    const links: Record<string, { label: string; href: string; target?: string; rel?: string }[]> =
        {
            ...
            Learn: [
                ...
                {
                    label: 'Roadmap',
                    href: 'https://github.com/orgs/telestack/projects',
                    target: '_blank',
                    rel: 'noopener noreferrer'
                },
                {
                    label: 'Source code',
                    href: 'https://github.com/telestack',
                    target: '_blank',
                    rel: 'noopener noreferrer'
                },
                {
            ...
            About: [
                ...
                {
                    label: 'Careers',
                    href: 'https://telestack.careers',
                    target: '_blank',
                    rel: 'noopener noreferrer'
                },
                {
                    label: 'Store',
                    href: 'https://telestack.store',
                    target: '_blank',
                    rel: 'noopener noreferrer'
                },
...
>
    <img class="web-logo" src="/images/logos/appwrite.svg" alt="TeleStack" height="24" width="130" />
