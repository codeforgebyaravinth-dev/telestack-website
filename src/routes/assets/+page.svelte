            ...
            <div class="web-grid-120-1fr-auto">
                ...
                <main class="web-grid-120-1fr-auto-main" id="main">
                    <div class="web-content">
                        <section>
                            <p>
                                Resources for presenting the TeleStack brand to maintain consistency
                        ...
                        <section id={getSectionId(Section.NAMING)}>
                            <div class="web-flex flex-col gap-2">
                                ...
                                <p>
                                    Write 'TeleStack,' with an uppercase 'T' and uppercase 'S'. Please refrain from using variations like 'telestack'
                                    or 'Tele Stack'.
                                </p>
                            </div>
                        </section>
