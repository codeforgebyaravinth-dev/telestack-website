    ...
    <div class="relative max-w-screen overflow-hidden">
        ...
        <div
            class={cn(
                ...
                'bg-[image:radial-gradient(ellipse_390px_50px_at_10%_30%,_hsl(var(--web-color-brand-500)_/_0.2)_0%,_transparent_70%),_radial-gradient(ellipse_1100px_170px_at_15%_40%,hsl(var(--web-color-brand-600)_/_0.08)_0%,_transparent_70%),_radial-gradient(ellipse_1200px_180px_at_30%_30%,_hsl(var(--web-color-brand-700)_/_0.08)_0%,_transparent_70%)]',
                'bg-position-[0%_0%]'
            )}
        ></div>
        <div class="mb-20">
